...
export default function AboutSection() {
  return (
    <div className="w-full lg:w-[50%] xl:w-[45%] flex flex-col justify-center items-center p-4 sm:p-6 md:p-8 relative">
      ...
      >
        <motion.h3 
          className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold uppercase tracking-wide leading-tight"
        ...
        <motion.button 
          className="border-2 border-[#004100] px-4 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 text-sm sm:text-base md:text-lg font-medium uppercase tracking-wide hover:bg-[#004100] hover:text-[#faab00] transition-all duration-300"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
